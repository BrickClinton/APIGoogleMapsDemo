...
MySQL - 10.4.24-MariaDB : Database - geolocationdb
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`geolocationdb` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
...
insert  into `establecimientos`(`idestablecimiento`,`iddistrito`,`establecimiento`,`ruc`,`tipocalle`,`nombrecalle`,`numerocalle`,`referencia`,`latitud`,`longitud`,`estado`) values 
(1,'010306','Camitas azules SAC','10042628811','AV','Las Gardenias','123','Al costado de la iglesia',-5.83194447,-77.91695404,''),
(2,'010203','Calles Ambiguas SAC','10942658821','AV','Los alamos','1223','Al lado de comisaria',-5.63845682,-78.44905090,''),
(3,'020103','Ojos de la justicia','10942258311','AV','Luis Masaro','1234','AL frente del parque',-9.59458160,-77.81112671,''),
(4,'020104','Matematicas El Tigre','10942529811','JR','28 de Julio','1235','2 cuadras antes del tecnologico',-9.72346020,-77.81981659,''),
(5,'060402','DiseMundis rt','10942658311','JR','8 de Agosto','1678','Atras del bar Los Olivos',-9.49787521,-77.61206055,''),
(6,'030101','Opera Sociales','10342658811','JR','9 de Diciembre','235','Al costado del circo Payaso',-13.63508320,-72.88567352,''),
(7,'030102','Tus palabras','10942651811','UR','Los ojos de Dios','765','Al frente de la notaria municipal',-14.00284672,-73.04478455,''),
(8,'030103','Vigilancia Segura','10942358811','UR','Pedro Caceres','357','Entre Jr Galvez Chipoco y Rosario',-13.87938118,-72.87633514,''),
(9,'040101','Asesores Unidos','10942678811','LT','San Beata Melchorita','345','Al frente del estadio',-16.40454674,-71.54656219,''),
(10,'040102','TraducemePe','10942628811','PJ','Juan de Dios','252','A tras de la cancha deportiva Mauro Mina',-16.35787392,-71.54507446,''),
(11,'110201','Abogados','44858585859','AV','Los garcilazos','25','Al costado de la pista',-13.42304230,-76.14642334,''),
(12,'110201','Electric ACD','44858585825','PJ','Los moras','25','Al costado de la pista',-13.44464779,-76.16635132,''),
(13,'110201','Rimac SERVICIO','58599999999','PJ','Los palomos','20','',-13.33399296,-76.11776733,'\0'),
(14,'050301','New establishment','85699999999','AV','Los sauces','5','',-15.06260777,-73.95297241,''),
(15,'080404','Transporte EDU','69696999999','AV','C alca','23',NULL,-13.10476398,-72.04553986,''),
(16,'060304','Soldaduras MISG','39554777777','JR','Junin','3',NULL,-6.83788013,-78.24591827,''),
(17,'150404','Mecanica','69696969999','JR','Árica',NULL,NULL,-11.40540314,-76.57822418,'');
...
/* Procedure structure for procedure `spu_establecimientos_buscar` */

/*!50003 DROP PROCEDURE IF EXISTS  `spu_establecimientos_buscar` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spu_establecimientos_buscar`(
...
/* Procedure structure for procedure `spu_establecimientos_listar` */

/*!50003 DROP PROCEDURE IF EXISTS  `spu_establecimientos_listar` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spu_establecimientos_listar`(
	IN _limit 					TINYINT,
	IN _offset 					INT
)
BEGIN
